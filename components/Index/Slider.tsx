...
class Slider extends React.Component<Props> {
  componentDidMount() {
    return new Swiper("." + this.props.slider.className + "-swiper", {
    ...
    return (
      <>
        {!this.props.slider.hidden && (
          <div
            key={this.props.slider.key}
            className={
              this.props.slider.className +
              "__slider popular-analises-swiper active"
            }
          >
            <div
              className={
                this.props.slider.className + "__wrapper swiper-wrapper"
              }
            >
            ...
            <div
              className={
                this.props.slider.className + "__slider-buttons swiper-buttons"
              }
            >
