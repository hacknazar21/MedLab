    ...
    selects:ISelect[] = [
        {
            key: 0,
            name: 'category',
            items: ['Артрит', 'Генетические расстройства', 'Гипертония','Беременность'],
            title: 'Все категории',
    ...
    return (
        <div className="analysis__filter-box analysis-filter">
            <div className="analysis-filter__header">
                ...
                <div className="analysis-filter__value">Найдено: <span>{this.props.number}</span></div>
            </div>
            <div className="analysis-filter__form filter-form">
                <div className="filter-form__input-box">
                    <input type="text" name="search"
                           placeholder="Поиск исследования"
                           className="filter-form__input" onInput={this.handleInputChange}/>
                </div>
                ...
                <div className="filter-form__input-box">
                    <div className="filter-form__input-checkboxes">
                        <div className="filter-form__input-checkbox">
                            <input name='adult' type="checkbox" id="amateur" value="Взрослым" onChange={this.handleInputChange}/>
                            <label htmlFor="amateur" className="filter-form__input">Взрослым</label>
                        </div>
                        <div className="filter-form__input-checkbox">
                            <input name='child' type="checkbox" id="child" value="Детям" onChange={this.handleInputChange}/>
                            <label htmlFor="child" className="filter-form__input">Детям</label>
                        </div>
                    </div>
                </div>
            </div>
