...
class News extends React.Component<Props, any> {
    componentDidMount() {
        return new Swiper('.news-swiper', { // Указываем скласс нужного слайдера
                                                    ...
                                                    <div className="news__card card">
                                                        ...
                                                        <div className="card__text">
                                                            <div className="card__desc">
                                                                <div className="card__desc-item">{date}</div>
                                                            </div>
                                                            <h3 className="card__title">
                                                                <a href={'/news/'+news.href} className="card__title-link">
                                                                    {news.title}
                                                                </a>
                                                            </h3>
                                                        </div>
                                                        <div className="card__info">
                                                            <div className="card__info-item">
                                                                <a href={'/news/'+news.href} className="card__info-link baner__button">Узнать подробнее</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
