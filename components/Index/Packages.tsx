...
export default function Packages(props: Props) {
  useEffect(() => {
    new Swiper(".popular-analises__slider.popular-analises-swiper.packages", {
  ...
  return (
    <section className="page__popular-analises popular-analises packages">
      <div className="popular-analises__container">
        <div className="popular-analises__box">
          <div className="popular-analises__header">
            ...
            <Link href="/researches/packages">
              <a className="popular-analises__show-all-pc show-all-pc">
                <span>смотреть все пакеты</span>
                <svg
            ...
            <div className="popular-analises__wrapper swiper-wrapper">
              <div className="popular-analises__slide swiper-slide">
                {props.packages?.map((packageItem) => {
                  return <ResearchPackageCard id={1} package={packageItem} />;
                })}
              </div>
            </div>
          </div>
          <a href="" className="popular-analises__show-all show-all">
            смотреть все пакеты анализов
          </a>
        </div>
      </div>
    </section>
