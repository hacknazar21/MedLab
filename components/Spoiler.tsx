...
export function Spoiler (props: Props) {
  ...
  return (
      <div className={className.join(' ')}>
          <button ref={spoilerTitle} onClick={handleSpolierClick} className='spoiler__title'>
              <p>{props.title}</p>
          ...
          <div ref={spoilerBody} style={isOpen ? {'max-height': `${maxHeight}px`} : {'max-height': '0px'}} className="spoiler__content">
