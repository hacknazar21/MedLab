...
class Api_Analyses(models.Model):
    ...
    banner_img = models.FileField(max_length=1000, blank=True, null=True, upload_to='imgAnalyse',
    ...
    main_img = models.FileField(max_length=1000, blank=True, null=True, upload_to='imgAnalyse',
