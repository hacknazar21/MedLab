    ...
    return (
        <>
            ...
            <div className="wrapper another">
                <MainLayout>
                    <Sugar sugar={[{title: 'Главная', href: '/'}, {title: 'Обычные анализы', href: '/catalog'}, {title: props.oneAnalysis.long_title, href: ''}]}/>
                    <main className='page research'>
                        {
                            ...
                            <section className="research__section">
                                <div className="research__container">
                                    <ResearchSlider banner_img={props.oneAnalysis.banner_img} long_title={props.oneAnalysis.long_title} />
                                </div>
                            </section>
                        }
                        <section className="research__section">
